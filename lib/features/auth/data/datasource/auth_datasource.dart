...
class AuthDatasource {
  ...
  Future<LoginResponse> login({required LoginRequest loginRequest}) async {
    final loginResponse = await _graphQl
  ...
  Future<LoginResponse> signUp({required SignUpRequest signUpRequest}) async {
    final signUpResponse = await _graphQl
        .login(AuthQuery().signUpMapQuery(signUpRequest: signUpRequest));
