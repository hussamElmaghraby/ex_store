...
class _ApiService implements ApiService {
  ...
  @override
  Future<UploadImageResource> uploadImage(FormData file) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = file;
    final _options = _setStreamType<UploadImageResource>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UploadImageResource _value;
    try {
      _value = UploadImageResource.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
